          ...
          .then(dataURL => {
            ...
            RNFS.mkdir(dirPath)
              ...
              .then(() => {
                ...
                ReceiptPrinter.initializeEzeAPI(initMsg => {
                  console.log(initMsg)
                  if (initMsg === "Initialization successful") {
                    ReceiptPrinter.printLargeReceipt(filePath, printMsg => {
                      console.log(printMsg)

                      RNFS.unlink(dirPath)
                        .then(() => console.log("Deleted folder:", dirPath))
                        .catch(err =>
                          console.error("Failed to delete folder:", err),
                        )

                      navigation.dispatch(
                        CommonActions.navigate(mainNavigationRoutes.home),
                      )
                    })
                  } else {
