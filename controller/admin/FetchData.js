...
const fetchtransNumber = async (req, res) => {
    try {
        ...
        let table = 'md_agent_trans a, md_agent b',
            ...
            where = `a.agent_code=b.agent_code AND a.bank_id =${user_data.bank_id} AND a.branch_code='${user_data.branch_code}' AND a.agent_trans_no IS NOT NULL AND a.coll_flag='N' AND a.end_flag='Y' AND a.received_date BETWEEN '${value.fDate}' AND '${value.tDate}'`,
