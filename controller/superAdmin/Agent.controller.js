...
const { db_Select, db_Insert, PRINTER_TYPE_MASTER } = require("../../model/MasterModule");
...
const add_agent = async (req, res) => {
  try {
    ...
    let fields =
        "(bank_id, branch_code,agent_code,agent_name,phone_no,email_id,max_amt,allow_collection_days,created_by,created_at)",
    ...
    //   status: false,
    // });
    req.flash("error", "Agent not added successfully");
    res.redirect("/super-admin/agent");
  }
};
...
const editAgentdata = async (req, res) => {
  ...
  let select = "a.agent_id,a.agent_code,a.branch_code,a.agent_name,a.phone_no,a.email_id,a.max_amt,a.allow_collection_days,a.bank_id,b.device_sl_no,b.device_id,b.active_flag,b.id,b.user_id,c.branch_name,a.printer_type",
...
const edit_save_agent_data = async (req, res) => {
  try {
    ...
    let fields = `device_id='${value.device_id}',active_flag='${
        value.agent_active ? value.agent_active : "N"
      }',modified_by='${user_data.id}',updated_at='${datetime}'`,
...
const add_sms = async (req, res) => {
  try {
    ...
    //   status: false,
    // });
    req.flash("error", "Template not added successfully");
    res.redirect("/super-admin/sms");
  }
};
...
const add_header_footer = async (req, res) => {
  try {
    ...
    // console.log(value)
    let fields =
        "(bank_id,header_1,header_1_flag,header_2,header_2_flag,header_3,header_3_flag,header_4,header_4_flag,footer_1,footer_1_flag,footer_2,footer_2_flag,footer_3,footer_3_flag,footer_4,footer_4_flag,created_by,created_dt)",
      values = `('${value.bank_id}','${value.header_1}','${
        value.header_1_flag == "Y" ? "Y" : "N"
      }','${value.header_2}','${value.header_2_flag == "Y" ? "Y" : "N"}','${
        value.header_3
      }','${value.header_3_flag == "Y" ? "Y" : "N"}','${value.header_4}','${
        value.header_4_flag == "Y" ? "Y" : "N"
      }','${value.footer_1}','${value.footer_1_flag == "Y" ? "Y" : "N"}','${
        value.footer_2
      }','${value.footer_2_flag == "Y" ? "Y" : "N"}','${value.footer_3}','${
        value.footer_3_flag == "Y" ? "Y" : "N"
      }','${value.footer_4}','${value.footer_4_flag == "Y" ? "Y" : "N"}','${
        user_data.id
      }','${datetime}')`;
...
const show_header_footer = async (req, res) => {
  try {
    let select =
        "a.bank_id,a.header_1_flag,a.header_2_flag,a.header_3_flag,a.header_4_flag,a.footer_1_flag,a.footer_2_flag,a.footer_3_flag,a.footer_4_flag,b.bank_name",
...
const edit_header_footer = async (req, res) => {
  let select =
      "a.bank_id,a.header_1,a.header_1_flag,a.header_2,a.header_2_flag,a.header_3,a.header_3_flag,a.header_4,a.header_4_flag,a.footer_1,a.footer_1_flag,a.footer_2,a.footer_2_flag,a.footer_3,a.footer_3_flag,a.footer_4,a.footer_4_flag,b.bank_name",
    table_name = "md_header_footer a, md_bank b",
    whr = `a.bank_id = b.bank_id
            AND a.bank_id = '${req.query.bank_id}'`;
  const resData = await db_Select(select, table_name, whr, null);
...
const edit_save_header_footer = async (req, res) => {
  try {
    ...
    let fields = `header_1='${value.header_1}',header_1_flag='${
        value.header_1_flag == "Y" ? "Y" : "N"
      }',header_2='${value.header_2}',header_2_flag='${
        value.header_2_flag == "Y" ? "Y" : "N"
      }',header_3='${value.header_3}',header_3_flag='${
        value.header_3_flag == "Y" ? "Y" : "N"
      }',header_4='${value.header_4}',header_4_flag='${
        value.header_4_flag == "Y" ? "Y" : "N"
      }',footer_1='${value.footer_1}',footer_1_flag='${
        value.footer_1_flag == "Y" ? "Y" : "N"
      }',footer_2='${value.footer_2}',footer_2_flag='${
        value.footer_2_flag == "Y" ? "Y" : "N"
      }',footer_3='${value.footer_3}',footer_3_flag='${
        value.footer_3_flag == "Y" ? "Y" : "N"
      }',footer_4='${value.footer_4}',footer_4_flag='${
        value.footer_4_flag == "Y" ? "Y" : "N"
      }',modified_by='${user_data.id}',updated_dt='${datetime}'`,
