...
const add_branch_admin = async (req, res) => {
  try {
    ...
    let fields2 =
        "(bank_id, branch_code, user_type, password, user_id, active_flag, created_by, created_at, delete_flag, profile_pic)",
    ...
    let fields =
        "(bank_id, branch_code, branch_name, branch_address, contact_person, phone_no, email_id, created_by, created_at, delete_flag, active_flag)",
    ...
    // });/
    req.flash("error", "Branch not added successfully");
    res.redirect("/super-admin/branch_admin");
  }
};
...
const updatedata_branch = async (req, res) => {
  try {
    ...
    //   status: false,
    // });
    req.flash("error", "Branch not updated successfully");
    res.redirect("/super-admin/branch_admin");
  }
};
